...
- [x] 07.1-08-PLAN.md — Fix whole-document HTTP 400 failures with post-chunk extraction and bounded sub-batching.
...
| 7.1. Document Graph RAG and GLiNER GPU (INSERTED) | 8/17 | In Progress|  |
